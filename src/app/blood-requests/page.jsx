  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-error mb-2">জরুরি রক্তের প্রয়োজন</h2>
        <p className="text-gray-600">রোগী পক্ষের দেওয়া রক্তের অনুরোধগুলো দেখুন। কোনো ডোনার রক্ত দিতে চাইলে সরাসরি যোগাযোগ করতে পারেন।</p>
      </div>
      ...
      {filteredRequests.length === 0 ? (
        <div className="text-center py-12 bg-base-100 rounded-xl border">
          <p className="text-lg text-gray-500">কোনো জরুরি রক্তের অনুরোধ পাওয়া যায়নি।</p>
        </div>
      ) : (
