      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm dark:shadow-lg border border-slate-100 dark:border-slate-800 flex items-center justify-between group">
          <div>
            ...
            <h3 className="text-3xl font-extrabold text-slate-800 dark:text-slate-100 mt-2">{totalUsers}</h3>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm dark:shadow-lg border border-slate-100 dark:border-slate-800 flex items-center justify-between group">
          <div>
            ...
            <h3 className="text-3xl font-extrabold text-slate-800 dark:text-slate-100 mt-2">{totalRequests}</h3>
          </div>
