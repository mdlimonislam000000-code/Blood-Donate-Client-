...
const GeneralInfo = () => {
  ...
  useEffect(() => {
    if (currentUser) {
      setFormData({
        ...
        image: currentUser.image || currentUser.userImage || "",
      ...
      setImagePreview(currentUser.image || currentUser.userImage || "");
    }
  }, [currentUser]);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      // ১. ব্যাকএন্ড API কল (MongoDB-এর user এবং nidVerifications কালেকশন আপডেট করার জন্য)
      ...
      if (res.ok) {
        // ২. Better Auth ক্লায়েন্ট আপডেট করা যাতে সেশন কুকি রিফ্রেশ হয়
        try {
          ...
          console.error("Auth client update error:", authErr);
        }
