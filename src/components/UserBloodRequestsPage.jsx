    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-error mb-2">
          আমার রক্তের অনুরোধসমূহ
        </h2>
        <p className="text-gray-600">
          আপনি যে রক্তের অনুরোধগুলো পোস্ট করেছেন তা এখানে দেখতে এবং ম্যানেজ করতে
          পারবেন।
        </p>
      </div>
                    ...
                    <div className="my-3 p-3 bg-red-50 dark:bg-gray-800 border border-red-200 dark:border-red-900/50 rounded-xl flex items-center justify-between animate-fadeIn">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-mono font-bold tracking-widest text-red-600 dark:text-red-400">
                            {req.donationCode}
                          </p>
                        </div>
                      </div>
              ...
              <div>
                ...
                <p className="text-xs text-red-100 mt-0.5">
                  ...
                  <span className="font-semibold">
                    {currentEditItem.patientName}
                  </span>{" "}
                  | হাসপাতাল:{" "}
                  <span className="font-semibold">
                    {currentEditItem.hospitalName}
                  </span>
                </p>
              </div>
              <button
